...
export const regions = [
  ...
  },
  {
    ...
    x1: 118,
    theme: "extreme",
    intro: "뜨거운 사막, 높은 산, 차가운 극지방! 특별한 동물을 만나요.",
    spawns: [
      ...
      { id: "북극곰", tx: 111, ty: 8, zone: "빙하", tip: "하얀 털의 왕", wanderX: [111, 118] },
      { id: "북극여우", tx: 115, ty: 12, zone: "눈밭", tip: "귀가 작아요", wanderX: [111, 118] },
      { id: "펭귄", tx: 112, ty: 25, zone: "얼음 물가", tip: "뒤뚱뒤뚱 걸어요", wanderX: [111, 118] },
      { id: "산양", tx: 109, ty: 29, zone: "높은 산 바위", tip: "절벽을 잘 올라요", wanderX: [108, 110] }
    ]
  }
];
